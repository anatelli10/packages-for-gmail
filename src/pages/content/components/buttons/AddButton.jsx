...
const AddButton = props => {
    ...
    const { user, packages, setPackages } = props;
    ...
    const validateTrackingNumber = event => {
        const tracking =
            event.target.value &&
            getTracking(event.target.value, validCouriers);
        setValues({
            ...values,
    ...
    const handleAddPackage = values => {
        ...
        authorizedFetch(user, `/accounts/add-package?email=${user}`, {
            ...
            .then(response => {
                ...
                enqueueSnackbar(
                    `Added package with tracking number ${trackingNumber} from ${sender}`,
                    {
                        variant: 'success'
                    }
                );
                ...
                <DialogContent>
                    ...
                    <Box display="flex" flexDirection="column">
                        ...
                        <TextField
                            ...
                            placeholder="eBay"
                            helperText={
                                values.senderError ? 'Invalid sender' : ''
                            }
                        />
                        <TextField
                            variant="outlined"
